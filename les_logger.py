...
def Init(defaultLogFile = __DEFAULT_LOG_OUTPUT_FILE__):
	...
	__s_defaultChannels__[CHANNEL_FATAL_ERROR] = CreateChannel("FATAL_ERROR", "FATAL_ERROR: ", defaultLogFile, 
										 																		 defaultFlags | LES_LOGGERCHANNEL_FLAGS_FATAL)

	__s_defaultChannels__[CHANNEL_ERROR] = CreateChannel("ERROR", "ERROR: ", defaultLogFile, defaultFlags)
	__s_defaultChannels__[CHANNEL_WARNING] = CreateChannel("WARNING", "WARNING: ", defaultLogFile, defaultFlags)
	__s_defaultChannels__[CHANNEL_LOG] = CreateChannel("LOG", "", defaultLogFile, defaultFlags)
